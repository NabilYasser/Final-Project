...
create_constraint_mode -name scan_constraints\
   -sdc_files\
    [list Design_Top_Sign_off.dat/mmmc/modes/scan_constraints/scan_constraints.sdc]
create_constraint_mode -name func_constraints\
   -sdc_files\
    [list Design_Top_Sign_off.dat/mmmc/modes/func_constraints/func_constraints.sdc]
create_constraint_mode -name capture_constraints\
   -sdc_files\
    [list Design_Top_Sign_off.dat/mmmc/modes/capture_constraints/capture_constraints.sdc]
